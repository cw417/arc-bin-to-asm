...
class TestDisassembly(unittest.TestCase):
  ...
  def test_arithmetic(self):
    ...
    addcc_asm_imm = "addcc %r2, 4, %r5"
    self.assertEqual("10 00101 010000 00010 1 0000000000100", parse_asm(addcc_asm_imm))
  ...
  def test_memory(self):
    ...
    ld_asm = "ld 2084, %r1"
    self.assertEqual("11 00001 000000 00000 1 0100000100100", parse_asm(ld_asm))

    # st
    st = "11 00011 000100 00000 1 0101111000100"
    self.assertEqual("st %r3, 3012", parse_binary(st))
    st_asm = "st %r3, 3012"
    self.assertEqual("11 00011 000100 00000 1 0101111000100", parse_asm(st_asm))
